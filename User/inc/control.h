...
#define CAR_ANGLE_SET -1.8 //KKDD// 0
#define CAR_ANGLE_SPEED_SET 0//KKDD//0
/******速度控制相关宏定义******/
...
extern int g_nSpeedTarget;//KKDD
extern int g_nLSpeedpwm;//KKDD
extern int g_nRSpeedpwm;//KKDD
...
void SetMotorVoltageAndDirection(int i16LeftVoltage,int i16RightVoltage);//KKDD

int LSpeedInnerControl(int nPulse,int nTarget);//KKDD
int RSpeedInnerControl(int nPulse,int nTarget);//KKDD
