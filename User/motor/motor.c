...
Version：V1.0
Date：2020
@brief：2020 	电机pwm驱动、正交解码、超声波脉宽捕获初始化
...
/* -----------------------------------------------------------------------
  ...
  TIM_TimeBaseStructure.TIM_Prescaler = 3;//3;	    //设置预分频：不预分频，即为72MHz
  ...
  //KKDD// TIM_OCInitStructure.TIM_Pulse = CCR1_Val;	   //设置跳变值，当计数器计数到这个值时，电平发生跳变
